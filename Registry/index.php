...
<?php subPageTop(); ?>
  ...
  <div class="descriptionText">
    ...
    <p><b>NOTE</b>: Once you have completed your Paypal transaction, please wait for the page to redirect you back to this site so the database can update.  You will see a confirmation message pop up when you return.</p>
